...
class SequenceDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, env='hopper-medium-replay', horizon=64, noise_level=None, noise_seed=None,
        ...
        fields.finalize(horizon = horizon, seed = self.noise_seed)
    ...
    def renormalize(self, new_normalizer, keys=['observations', 'actions', 'trajectories']):
        """
    ...
    def __getitem__(self, idx, eps=1e-4):
        ...
        if self.noise_seed is not None and self.noise_level is not None:
            trajectories += self.noise_level * self.fields.trajectory_noise[path_ind, start:end]
