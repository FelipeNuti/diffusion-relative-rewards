# Taken from https://github.com/lucidrains/denoising-diffusion-pytorch/blob/main/denoising_diffusion_pytorch/guided_diffusion.py
...
class ValueUnet(nn.Module):
    def __init__(
        ...
        self.final_conv = nn.Sequential(
            nn.Conv2d(mid_dim, mid_dim, kernel_size = 2, stride = 2),
            nn.SiLU(),
            nn.Conv2d(mid_dim, mid_dim, kernel_size = 2, stride = 2),
            nn.SiLU(),
            nn.Conv2d(mid_dim, mid_dim, kernel_size = 2, stride = 2),
