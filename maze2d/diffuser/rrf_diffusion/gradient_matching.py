...
class GradientRewardRegressor(nn.Module):
    ...
    def _get_gradients(self, x_t, cond, t):
    ...
    def loss(self, x_start, cond, t = None):
        ...
        gradients, info = self._get_gradients(out_general, cond, t)
...
class GradientRewardSingleStep(GradientRewardRegressor):
    # TODO include functions to put outputs of Diffusion models in right form 
    # e.g. to ensure they are both outputting scores or conditional means
    # For now use only conditional means
